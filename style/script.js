document.addEventListener('DOMContentLoaded', () => {
    ...
    const members = [
    { name: 'Hà Anh', nickname: 'Hành', quote: 'ê buồn quá à.', img: 'style/img/ThanhVien/anh.jpg', hobbies: 'đáng yêu là thíchhh', message: 'khong biét nữaa, nhưng mà mình chưa muốn lớn đâu huhu' },
    { name: 'Hải Biên', nickname: 'Hải Biên', quote: 'ê cu.', img: 'style/img/ThanhVien/bien.jpg', hobbies: 'chơi thể thao', message: 'good boy.' },
    { name: 'DT Cẩm', nickname: 'jin', quote: 'chắc là khong có.', img: 'style/img/ThanhVien/cam.jpg', hobbies: 'Nhìn mưa, Nghe nhạc', message: 'Chúc B thi tốt đậu nv 1 nha><' },
    ...
    { name: 'Văn Huỳnh', nickname: 'Huỳnh Đây', quote: 'Siuuuuuuuu.', img: 'style/img/ThanhVien/huynh.jpg', hobbies: 'Ca hát ( nhạc ballad, bolero,trữ tình.....) chơi thể thao (Bóng chuyền,đá cầu, cầu lông.....)', message: 'Chúc các bạn vui vẻ, hạnh phúc,may mắn,thi tốt,bình an.' },
    ...
    { name: 'Dương Vinh', nickname: 'dw vin', quote: 'cái gì nhiều cũng k tốt nên dành ra 1 chút thời gian để thư giãn đầu óc sau những buổi học nhé.', img: 'style/img/ThanhVien/vinh.jpg', hobbies: 'bóng chuyền và ngủ ', message: 'cùng gắn bó với sau qua quãng thời gian dài , nhưng mình lại rời xa lớp vào những phút cuối cùng của thanh xuân chỉ mong sau khi thi lớp mình còn có thể ngồi lại với nhau thêm 1 lần nữa .' },
];
